...
if __name__ == "__main__":
    model_path = "/content/drive/MyDrive/SIIT_project/Snoring/seniorProject/MobileNetV2_size224_bs16"
    audio_path = '/content/drive/MyDrive/SIIT_project/Snoring/seniorProject/record_test.mp3'

    model = load_model(model_path)
    wav, sequence_stride, min_wav = preprocess_audio(audio_path, SNR_dB=0)
